    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(name.isEmpty() && e_mail.isEmpty() && username.isEmpty() && password.isEmpty()){
                    Toast.makeText(Signup_Activity.this, "Nothing Entered", Toast.LENGTH_LONG).show();
                }else{
                    if (!name.isEmpty()) {
                        sign1.setText(name);
                    }
                    ...
                    if (!password.isEmpty()) {
                        if(password.length()>=8){
                            ...
                            Toast.makeText(Signup_Activity.this,"Passwords should be more than 8 characters", Toast.LENGTH_LONG).show();
                        }
                    }else{
                        Toast.makeText(Signup_Activity.this,"Passwords should not be Empty", Toast.LENGTH_LONG).show();
