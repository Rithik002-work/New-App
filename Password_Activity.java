            ...
            public void onClick(View v) {
                ...
                if(!password.isEmpty()) {
                    if (password.length() <= 8) {
                        ...
                        Toast.makeText(Password_Activity.this,"Password should be within 8 Characters ", Toast.LENGTH_LONG).show();
                ...
                if(password.equals(re_password) && password.length() <= 8){
                    Toast.makeText(Password_Activity.this,"password successfully changed", Toast.LENGTH_SHORT).show();
